<?php
    ...
    class AjaxCalificacion{
        ...
        public function AjxListarProfesor(){
            $objADMIN = ControladorCalificacion::CtrlListarProfesor();
            $oBJEC_JSON = '{
                "data": [';
                    if (count($objADMIN) >= 1){
                        for ($i=0; $i < count($objADMIN); $i++) {
        ...
        public function AjxListarEstudiante(){
            $objADMIN = ControladorCalificacion::CtrlListarEstudiante();
            $oBJEC_JSON = '{
                "data": [';
                    if (count($objADMIN) >= 1){
                        for ($i=0; $i < count($objADMIN); $i++) {
        ...
        public function AjxListarAcudiente(){
            $objADMIN = ControladorCalificacion::CtrlListarAcudiente();
            $oBJEC_JSON = '{
                "data": [';
                    if (count($objADMIN) >= 1){
                        for ($i=0; $i < count($objADMIN); $i++) {
