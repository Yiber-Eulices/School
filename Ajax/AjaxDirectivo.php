<?php
    ...
    class AjaxDirectivo{
        ...
        public function AjxCrear(){
            $objDIRE= ControladorDirectivo::CtrlCrear( $this->nombre,$this->cargo,$this->correo,$this->telefono);
            echo json_encode($objDIRE);
        }
        public function AjxEditar(){
            $objDIRE= ControladorDirectivo::CtrlEditar( $this->id,$this->nombre,$this->cargo,$this->correo,$this->telefono);
            echo json_encode($objDIRE);  
        }
