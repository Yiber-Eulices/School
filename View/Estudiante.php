                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <button type="button" class="btn btn-success waves-effect"  data-toggle="modal" data-target="#miModal">
                                ...
                                <span>A&ntilde;adir Estudiante</span>
                            </button>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn bg-success waves-effect" onclick="location.href='AcudienteEstudiante.php'">
                                                    <i class="material-icons">visibility</i>
                                                    <span>Ver Acudientes</span>
                                                </button>
                                                <button type="button" class="btn bg-success waves-effect" onclick="location.href='Calificacion.php'">
                                                    <i class="material-icons">visibility</i>
                                                    <span>Ver Calificaciones</span>
                                                </button>
                                                <button type="button" class="btn bg-success waves-effect" onclick="location.href='Matricula.php'">
                                                    <i class="material-icons">visibility</i>
                                                    <span>Ver Matriculas</span>
                                                </button>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">A&ntilde;adir Estudiantes</h5>
            ...
            <div class="modal-body">
                ...
                <div class="form-group form-float"> 
                    ...
                    <select class="form-control show-tick selectpicker form-control" data-container="body" data-live-search="true" title="Select a number" data-hide-disabled="true" name ="TxtAutobus" requiere>
                        ...
                        <option value="<1>">Septimo</option> 
                        <option value="<1>">Octavo</option>
                        <option value="<1>">Noveno</option>
                        <option value="<1>">D&eacute;cimo</option>
                        <option value="<1>">Und&eacute;cimo</option>
                    </select>
