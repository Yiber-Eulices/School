            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                               ESTUDIANTES DE EL ACUDIENTE YIBER EULICES
                            </h2>
                        ...
                        <div class="body">
                            ...
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ventana2"><i class="material-icons">add</i>Agregar Estudiante</button><br><br>
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td> <button type="button" class="btn bg-success waves-effect" onclick="location.href='Calificacion.php'">
