                        ...
                        <div class="header">
                            <div class="row clearfix">
                                <div class="col-xs-12 col-sm-6">
                                    ...
                                    <h2>Boletin de <b id = "NumPeriodo"></b> de el Estudiante <b><?php echo($_SESSION['EstudianteNombre']);?></b> de el Curso <b><?php echo($_SESSION['GradoNombre']." ".$_SESSION['CursoNombre']);?></b>.</h2>
                                </div>
                            </div>
...
<script src="View/js/Teacher/Boletin.js"></script>
<?php
