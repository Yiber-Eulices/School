...
$.extend( $.validator, {
	...
	messages: {
		...
		url: "Por favor introduzca un URL v&aacute;lido.",
		...
		maxlength: $.validator.format( "Ingrese no m&aacute;s de {0} caracteres." ),
		...
		step: $.validator.format( "Ingrese un m&uacute;ltiplo de {0}." )
	},
