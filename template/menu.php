                                ...
                                <ul class="menu">
                                    <li>
                                        <a href="javascript:void(0);">
                                            ...
                                            <div class="menu-info">
                                                <h4>12 nuevos miembros se unieron</h4>
                                                <p>
                                    ...
                                    <li>
                                        <a href="javascript:void(0);">
                                            ...
                                            <div class="menu-info">
                                                <h4><b>Nancy Perez </b>cuenta eliminada</h4>
                                                <p>
                                    ...
                                    <li>
                                        <a href="javascript:void(0);">
                                            ...
                                            <div class="menu-info">
                                                <h4><b>John</b> comentó tu ppublicación</h4>
                                                <p>
                                    ...
                                    <li>
                                        <a href="javascript:void(0);">
                                            ...
                                            <div class="menu-info">
                                                <h4><b>John</b> actualizó su estado</h4>
                                                <p>
                                                    <i class="material-icons">access_time</i> hace 3 horas
                                                </p>
                                            </div>
